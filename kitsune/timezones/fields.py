...
from kitsune.timezones import zones
from kitsune.timezones.utils import coerce_timezone_value, validate_timezone_max_length
...
class TimeZoneField(models.CharField):
    ...
    # TODO: is this doing what we need it to do?
    # this is the suggested fix when removing __metaclass__ = models.SubFieldbase
